...
import com.xiaopeng.iotlib.provider.voice.command.AiotSpeechObserver;
/* loaded from: classes.dex */
public class AiotSpeechObserver_Stub extends Binder implements IInterface {
    public AiotSpeechObserver provider = new AiotSpeechObserver();
    public AiotSpeechObserver_Manifest manifest = new AiotSpeechObserver_Manifest();
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 0) {
            parcel.enforceInterface(AiotSpeechObserver_Manifest.DESCRIPTOR);
            ...
            if (i == 1598968902) {
                parcel2.writeString(AiotSpeechObserver_Manifest.DESCRIPTOR);
                return true;
            }
