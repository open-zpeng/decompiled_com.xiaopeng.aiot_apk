...
import com.xiaopeng.aiot.device.childseat.vm.ChildSeatVM;
import com.xiaopeng.iotlib.base.BasePage;
/* loaded from: classes.dex */
public class ChildSeatPage extends BasePage<AppView> {
    public ChildSeatPage(Lifecycle lifecycle) {
        super(lifecycle);
    }
    ...
    public void onCreateViewModel(ViewModelProvider viewModelProvider, AppView appView) {
        appView.setViewData((ChildSeatVM) viewModelProvider.get(ChildSeatVM.class));
    }
}
