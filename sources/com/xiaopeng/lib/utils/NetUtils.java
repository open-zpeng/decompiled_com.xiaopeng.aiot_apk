...
public class NetUtils {
    ...
    public static String getIMEI(Context context) {
        return ((TelephonyManager) context.getSystemService(Watches.PROP_PHONE_NUMBER)).getDeviceId();
    }

    public static String getNetworkOperatorName(Context context) {
        return ((TelephonyManager) context.getSystemService(Watches.PROP_PHONE_NUMBER)).getNetworkOperatorName();
    }

    public static int getSimState(Context context) {
        return ((TelephonyManager) context.getSystemService(Watches.PROP_PHONE_NUMBER)).getSimState();
    }
